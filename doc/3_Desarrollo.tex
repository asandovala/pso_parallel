...
\begin{figure}[htbp]
     \centering
        \subfigure[Evolucion de la solucion.]{
            \label{fig:EV_SOL}
            \includegraphics[width=0.5\textwidth]{figures/ev_solution.png}
        }%
        \subfigure[Comparacion solución inicial y final, 2015.]{
           \label{fig:COMP_INI_END}
           \includegraphics[width=0.5\textwidth]{figures/sol_ini_sol_fin.png}
        }\\ %  ------- End of the first row ----------------------%
        \subfigure[Ejemplo de mal ajuste, 2015.]{
            \label{fig:BAD_ADJUST}
            \includegraphics[width=0.5\textwidth]{figures/bad_adjust.png}
        }
        \subfigure[Solucion inicial y final, 2014.]{
            \label{fig:SOL_14}
            \includegraphics[width=0.5\textwidth]{figures/sol_ini_sol_fin_2014.png}
        }\\
         \subfigure[Solucion inicial y final, 2013.]{
            \label{fig:SOL_13}
            \includegraphics[width=0.5\textwidth]{figures/sol_ini_sol_fin_2013.png}
        }
...
\begin{figure}[ht!]
    \begin{center}
        ...
        \subfigure[Solución inicial y final, Julio.]{
            ...
            \includegraphics[width=0.5\textwidth]{figures/sol_ini_sol_fin_JULIO.png}
        }
         %\subfigure[Solución inicial y final, Agosto.]{
         %   \label{fig:PLOT_SOL_AGOSTO}
         %   \includegraphics[width=0.5\textwidth]{figures/sol_ini_sol_fin_AGOSTO.png}
        %}\\
...
ads\cite{goodFitTest}

%%Chi square table
sad\cite{chiSquareTable}
